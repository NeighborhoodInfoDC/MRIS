/* Dollar_convert_month.sas   
   ...
   11/04/14 S Zhang Added Feb 2014 - Sept 2014
 ****************************************************************************/
...
%macro Dollar_convert_month( amount1, amount2, from_m, from_y, to_m, to_y, series=CUUR0000SA0, quiet=Y, mprint=N );
 ...
 %if &series = CUUR0000SA0 %then %do;
  ...
  %let	CPI_22014	=	234.781;
  %let	CPI_32014	=	236.293;
  %let	CPI_42014	=	237.072;
  %let	CPI_52014	=	237.900;
  %let	CPI_62014	=	238.343;
  %let	CPI_72014	=	238.250;
  %let	CPI_82014	=	237.852;
  %let	CPI_92014	=	238.031;
  %let	CPI_102014	=.	;
  %let	CPI_112014	=.	;
  %let	CPI_122014	=.	;
%end;
  ...
  %let	CPI_22014	=	224.665;
  %let	CPI_32014	=	226.391;
  %let	CPI_42014	=	227.302;
  %let	CPI_52014	=	228.124;
  %let	CPI_62014	=	228.531;
  %let	CPI_72014	=	228.084;
  %let	CPI_82014	=	227.302;
  %let	CPI_92014	=	227.361;
  %let	CPI_102014	=.	;
  %let	CPI_112014	=.	;
  %let	CPI_122014	=.	;
%end;
