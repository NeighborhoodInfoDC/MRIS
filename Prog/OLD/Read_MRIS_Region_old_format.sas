...
%let cities  =dc?alex?arl?mont?pg?fairfax county?fairfax city?falls church?
...
%let path = d:\hnc2009\mris\source data\;
...
%if &year. ge 2003 %then %do;
filename xlscnty dde "excel|&path.&year.\[&wbook. &year.&suff..xls]&wbook. &year.!R3C1:R3C1" notab lrecl=1000;/*County name*/
filename xlsdate dde "excel|&path.&year.\[&wbook. &year.&suff..xls]&wbook. &year.!R4C1:R4C1" notab lrecl=1000;/*Date*/
...
data test&cnty.;
length mriscnty $30. mrisdate $30.;
ucounty = "&cnty";

infile xlscnty missover dsd dlm = '09'x  ;
input mriscnty: ;

infile xlsdate missover dsd dlm = '09'x  ;
input mrisdate: ;
...
tables testmort testdays mrisdate mriscnty;
run;
