/************************************************************************
 ...
 Modifications: 09/02/11 LH: Updated with 2011_07. 
				...
				05/08/12 RG: Updated with complete 2012_02 data.
				05/08/12 RG: Updated with 2012_03
				05/16/12 RG: Updated with 2012_04
				05/22/12 RG: Updated with new financing percent variables. Rerun with 2012_04
				08/03/12 RG: Updated with 2012_05
				08/03/12 RG: Updated with 2012_06
				08/21/12 RG: Updated with 2012_07
				03/08/13 RG: Updated with 2012_08
				03/08/13 RG: Updated with 2012_09
				03/08/13 RG: Updated with 2012_10
				03/13/13 RG: Updated with 2012_11
				03/14/13 RG: Updated with 2012_12
				03/14/13 RG: Updated for 2013 data and with 2013_01
				08/07/13 RG: Updated 2013_02 - 2013_06
				03/07/14 SXZ: Updated with 2013_08
				03/07/14 SXZ: Updated with 2013_09
				03/07/14 SXZ: Updated with 2013_10
				03/07/14 SXZ: Updated with 2013_11
				03/07/14 SXZ: Updated with 2013_12
				03/07/14 SXZ: Updated with 2014_01
...
%do y = 1999 %to 2013;
	...
	*other indicators;
		...
		pct_cash_&y._&month=cash_&y._&month/fin_total_&y._&month*100; 
		pct_fha_va_&y._&month=fha_&y._&month/fin_total_&y._&month*100; 
		pct_conv_&y._&month=conventional_&y._&month/fin_total_&y._&month*100; 
	...
	label medsaleR&y._&month. ="Adjusted Median Sold Price &y._&month (&to_month.-&to_year. $)"
		  ...
		  pct_cash_&y._&month = "Percent of Sales that were Cash Sales &y._&month (&to_month.-&to_year. $)" 
		  pct_fha_va_&y._&month = "Percent of Sales with Conventional Financing &y._&month (&to_month.-&to_year. $)" 
		  pct_conv_&y._&month = "Percent of Sales with FHA or VA Financing &y._&month (&to_month.-&to_year. $)" 
		  ;
%end; 
%end; 
...
%macro outmris(var);
filename outexc dde "Excel|&_dcdata_path\MRIS\Data\[RBI_county_month.xls]&var.!R7c4:R38C250" ;
data _null_ ;
