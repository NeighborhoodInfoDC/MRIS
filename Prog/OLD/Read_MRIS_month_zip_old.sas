...
%include 'k:\metro\kpettit\hnc2009\programs\mris\read_month_macros.sas';
...
%macro readmrism2 (year,geog, month,sep1);
...
%let path = D:\hnc2009\mris\source data\KathyZipCodeData\KathyZipCodeData\bin\combined runs\;
...
%readmrism2(year=2009,geog=zip,sep1=d);
/*
