/************************************************************************
 ...
 Modifications: 09/02/11 LH: Updated with 2011_07. 
				...
				04/18/14 SXZ: Updated with 2014_02
				04/18/14 SXZ: Updated with 2014_03
...
%let to_month=10;
%let to_year=2012;
%let months=10; *how many months of the last year are present;
%let months0=10; *when zero is needed;
